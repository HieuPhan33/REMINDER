    ...
    def load_from(self, weights):
        with torch.no_grad():
            ...
            if self.embeddings.hybrid:
                self.embeddings.hybrid_model.root.conv.weight.copy_(np2th(res_weight["conv_root/kernel"], conv=True))
...
if __name__ == '__main__':
    ...
    import os 
    print(os.path.exists(config.pretrained_path))
    net = Transformer(config, img_size=256, num_classes=21843, zero_head=False, vis=False)
