    ...
    def validate(self, loader, metrics, ret_samples_ids=None, logger=None, end_task=False):
        ...
        with torch.no_grad():
            for i, (images, labels, names) in enumerate(loader):
                ...
                if ret_samples_ids is not None and names[0] in ret_samples_ids:  # get samples
                    ret_samples.append((images[0].detach().cpu().numpy(), labels[0], prediction[0], names[0]))
